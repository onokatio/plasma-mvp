...
def application(request):
    ...
    dispatcher["apply_deposit_utxo"] = lambda blknum, txindex, oindex, transaction: child_chain.apply_deposit_utxo(blknum, txindex, oindex, rlp.decode(utils.decode_hex(transaction), Transaction))
